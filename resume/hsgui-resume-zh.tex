...
\cventry{2014.4 -- 2015.10}{软件开发工程师}{微软中国ASG}{苏州}{}{
	...
	\item 2014.4 -- 2014.09: Conversation Understanding Toolkit Team.
		...
		\item 负责： CUTrain, CUTester, CUHotfixTool的维护与升级, CUPhoneTester, CUPhoto demo App, ActiveLearning Tool开发
		\end{itemize}
	...
	\item 2015.3 -- 2015.10: Index Serve PDI team.
		...
		\item 负责： 测试机器升级对正排索引服务容量的影响，重构UnitTest程序，SSD的混合写对正排索引服务的影响，升级正排索引的生成接口以加快正排索引的更新速度，分离正排索引服务
		\end{itemize}
	\end{itemize}
}
